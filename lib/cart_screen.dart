...
class CartScreen extends StatelessWidget {
  ...
  Widget _buildCartSummary(Cart cart) {
    return Column(
      children: [
        _buildCartSummaryItem('Subtotal', '\$${cart.subTotal.toStringAsFixed(2)}'),
        _buildCartSummaryItem('Tax (5%)', '\$${cart.tax.toStringAsFixed(2)}'),
        _buildCartSummaryItem('Total', '\$${cart.total.toStringAsFixed(2)}', isTotal: true),
      ],
    );
  }

  Widget _buildCartSummaryItem(String title, String value, {bool isTotal = false}) {
    return Padding(
